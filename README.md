...
domain name `artisanalraisinbeer.com`, and set up all of the DNS
...
We go about this two ways: [robots.txt](http://www.robotstxt.org/robotstxt.html)
...
For search engines that respect
